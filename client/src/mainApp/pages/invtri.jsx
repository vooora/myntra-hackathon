...
function Invtri() {
  ...
  return (
    <div className="invtri-container">
      <h2>Select the Styles you like</h2>
      <div className="invtri-image-container">
        <img src={images[currentImageIndex]} alt="Body type" />
      </div>
      <div className="invtri-button-container">
      <button
        onClick={handleYes}
        ...
        <button className="invtri-next-button" onClick={handleNext}>Next</button>
      </div>
