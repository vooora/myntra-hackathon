#this code does not make a test split and utilises the entire dataset to train the model
import numpy as np
import cv2
...
dataset_path = 'processed_dataset2'
...
test_image_path = 'processed_dataset2/apple/7.jpeg'
