...
def get_embedding(img_path):
    img = image.load_img(img_path, target_size=(299, 299))  # InceptionV3 uses 299x299 images
...
if test_image is None:
    ...
    test_image_resized = cv2.resize(test_image, (299, 299))  # InceptionV3 uses 299x299 images
